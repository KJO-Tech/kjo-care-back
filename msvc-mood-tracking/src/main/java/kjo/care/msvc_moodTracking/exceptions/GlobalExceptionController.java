...
public class GlobalExceptionController {
    ...
    public ResponseEntity<ApiResponseDto<Object>> handleMoodEntityNodFoundException(MoodEntityNotFoundException ex) {
        log.warn("Mood not found:{}", ex.getMessage());
        return ResponseBuilder.buildResponse(HttpStatus.NOT_FOUND, "Ha ocurrido un error con el MOOD", false, Collections.singletonList(ex.getMessage()));
    }
}